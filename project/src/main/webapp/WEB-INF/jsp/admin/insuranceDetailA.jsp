...
<form action="${ pageContext.request.contextPath}/updateItemProc" method="post" name="updateItem">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0 text-bold" style="font-size: 20px;">보험 상품 수정</p>
                <button class="btn btn-getstarted btn-sm ms-auto">상품 수정</button>
              </div>
            </div>
            <div class="card-body">
              ...
              <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="no" type="text" value='<c:out value="${insuranceitem.no}"></c:out>'>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="form-floating">
                          <select class="form-select form-control" name="insuranceType" id="floatingSelect insuranceType" aria-label="Financial Consultancy">
                              <option selected=""><c:out value="${insuranceitem.insuranceType}"></c:out></option>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select class="form-select form-control" name="signType" id="floatingSelect insuranceType" aria-label="Financial Consultancy">
                              <option selected=""><c:out value="${insuranceitem.signType}"></c:out></option>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="insuranceName" type="text" value='<c:out value="${insuranceitem.insuranceName}"></c:out>'>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">보험료</label>
                    <input class="form-control" name="insuranceFee" type="number" value='<c:out value="${insuranceitem.insuranceFee}"></c:out>'> 
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">가입연령</label>
                    <input class="form-control" name="signAge" type="text" value='<c:out value="${insuranceitem.signAge}"></c:out>'>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">보장항목</label>
                    <input class="form-control" name="protectItem" type="text" value='<c:out value="${insuranceitem.protectItem}"></c:out>'>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="example-text-input" class="form-control-label">보장금액</label>
                    <input class="form-control" name="protectFee" type="text" value='<c:out value="${insuranceitem.protectFee}"></c:out>'>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input class="form-control" name="remark" type="text" value='<c:out value="${insuranceitem.remark}"></c:out>'>
                  </div>
                </div>
              </div>
